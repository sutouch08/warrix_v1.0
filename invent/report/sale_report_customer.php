<?php 
	$page_menu = "invent_sale_report_customer";
	$page_name = "รายงานยอดขาย แยกตามลูกค้า";
...
$(document).ready(function(e) {
	...
	$("#report_form").attr("action","controller/reportController.php?export_sale_by_customer&view="+view+"&"+view_report+"&customer="+customer+"&"+customer_rank );
...
function get_report(){
	...
	$.ajax({
		url:"controller/reportController.php?sale_by_customer&view="+view+"&"+view_report+"&customer="+customer+"&"+customer_rank , type:"GET",cache:false,
